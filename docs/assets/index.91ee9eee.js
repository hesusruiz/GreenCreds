...
`;class y extends o{constructor(){console.log("Inside constructor of HEADERBAR"),super()}render(){return a`
        ...
        `}enter(){console.log("Enter page DEMO"),this.style.display="block",this.requestUpdate()}};let B=L;i(B,"styles",[L.styles,s`
        .plus {
            --t:3px;   /* Thickness */
        ...
        `]),customElements.define("passenger-home",B);customElements.define("demo-page",class extends M{static get properties(){return{perico1:{type:Object},perico2:{attribute:!1}}}constructor(){console.log("Inside constructor of DEMO PAGE"),super(),this.perico1="default 111111",this.perico2="default 222222"}render(){return a`
        <!-- =========================================== -->
        ...
        `]),customElements.define(U,V),U="scanqr-result";class G extends o{static get properties(){return{pepe:{attribute:!0}}}constructor(){console.log("Inside constructor of SCANRESULT"),super(),this.thehtml="",this.qrContent="",this.hcert=void 0,this.verified=!1}render(){return a`
            ...
            <!-- =========================================== -->
            ${this.thehtml}
            `}async enter(e){console.log("PRESENT Enter",e),this.qrContent=e.text,this.style.display="block";try{this.hcert=await R.decodeHC1QR(this.qrContent,!0),this.verified=this.hcert[3]}catch(i){return void v.myerror("Error verifying credential",i)}try{this.thehtml=function(e){let i=e[1],t="Unrecognized";"v"==i.certType&&(t=a`
        ...
        `);return t}(this.hcert)}catch(i){return void v.myerror("Error rendering credential",i)}this.requestUpdate()}async exit(){}}i(G,"styles",[g,s`
        #footer {
            position: fixed;
            bottom: 0
        }
        `]),customElements.define(U,G);class N extends o{static get properties(){return{pepe:{attribute:!0}}}constructor(){console.log("Inside constructor of SCANRESULT"),super(),this.thehtml="",this.qrContent="",this.hcert=void 0,this.verified=!1}render(){return a`
            <!-- =========================================== -->
            <!-- SCAN RESULT PAGE.                           -->
            <!-- =========================================== -->
            ${this.thehtml}
            `}async enter(e){console.log("PRESENT Enter",e),this.qrContent="HC1:NCFOXN%TSMAHN-HPO45JVLFDISVM85:D4*OV-36QHN-TM5*KQM3*GML0FXIKMWDWYPWHH:ZH6I1$4JN:IN1MPK9V L9L69UEG%6M415BEC4633F-96SW6SJE3ZMXDMUF6NZ6E6AH+932Q6G39ZILAPZXI$MI1VCSWC%PDMOL7AD.XIIXB0 J5QB06JOMI/LKW1JVTIM7JZIJI7JIZI.EJJ14B2MZ8DC8CWVD 8D*NI+PB/VSQOL9DLKWCZ3E7KDW0KZ J$XI4OIMEDTJCJKDLEDL9CZTAKBI/8D:8DKTDL+SQ05.$S6ZCJKBPKJDG3LWTXD3/9TL4T.B9GYP8T1+1V$LA*ZEBH1T+UZ%HQK9CZPME1.*UWKU/.1ZY9 UPG706ZRB KYZQBK9-RUUBCFRMLNKNM8JI0JPGO7HWPAG2B5VL3K9OTJ0UL4ZVBWSA81TXH4YVZ38+APZGJKDJB1PGB49WE*7CY2P3LM DOLQ9KKAX15BP3:GNSFKPOQU-0DCOTCPHXOP40SF355",this.style.display="block";try{this.hcert=await R.decodeHC1QR(this.qrContent,!0),this.verified=this.hcert[3]}catch(i){return void v.myerror("Error verifying credential",i)}try{this.thehtml=this.renderDetail(this.hcert)}catch(i){return void v.myerror("Error rendering credential",i)}this.requestUpdate()}async exit(){}toggleView(e){this.renderRoot.querySelector(e).classList.toggle("w3-show")}renderDetail(e){let i=e[1],t="Unrecognized";return"v"==i.certType&&(t=a`
        ...
        `]),customElements.define("display-hcert",N);class O extends o{constructor(){console.log("Inside constructor of PAGE404"),super()}render(){return a`
        <div class="jrmpage w3-container">
            <h1>The page does not exist!</h1>
        </div>
        `}enter(){console.log("Enter page"),this.style.display="block",this.requestUpdate()}}i(O,"styles",[g]),customElements.define("page-404",O);var Y=[{name:"demo",tagName:"demo-page"},{name:"passenger",tagName:"passenger-home"},{name:"verifier",tagName:"scanqr-page"},{name:"scanresult",tagName:"scanqr-result"},{name:"displayhcert",tagName:"display-hcert"},{name:"page404",tagName:"page-404"}];document.body.innerHTML="";let q=document.createElement("router-elem");document.body.append(q);for(let z=0;z<Y.length;z++){let e=document.createElement(Y[z].tagName);e.style.display="none",document.body.append(e),K=Y[z].name,Q=e,console.log("ROUTER: register page:",K),w.set(K,Q)}var K,Q,H="displayhcert";if(window.location.search.length>0){let e=new URLSearchParams(window.location.search);null!==e.get("home")?H="passenger":null!==e.get("verifier")?H="verifier":null!==e.get("demo")?H="demo":null!==e.get("admin")?H="admin":null!==e.get("pubcred")?H="pubcreds":v.mywarn("URL parameter not recognised",window.location.search)}console.log("Home_page:",H),m=H;const F="https://safeislandtest.hesusruiz.org";window.addEventListener("load",(async e=>{await async function(){if(console.log("Performing OneTime Initialization"),1!=await async function(e){try{var i=await p.settings.get(e)}catch(t){console.error(t),alert("Error in get setting")}if(null!=i)return i.value}("initialized")){try{await u("apiHost",F)}catch(e){v.myerror("Onetime initialization error")}await u("initialized",!0)}}();let i=window.location.search,t=new URLSearchParams(i),s=t.get("id");if(s){var o="https://api.lanzarotesafe.org/sms/"+s;await requestQRAndDisplay(o,"displayCredentialPage","fromPassengerScan")}else{if(s=t.get("pubid"),s){o="https://safeislandtest.hesusruiz.org/api/verifiable-credential/v1/public/"+s;return console.log("Public Credential",o),void(await requestQRAndDisplay(o,"displayCredentialPage","fromPassengerScan"))}await k()}}));
