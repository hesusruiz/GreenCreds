...
`;class y extends o{constructor(){console.log("Inside constructor of HEADERBAR"),super()}render(){return a`
        ...
        `]),customElements.define(B,G),B="scanqr-result";class V extends o{static get properties(){return{pepe:{attribute:!0}}}constructor(){console.log("Inside constructor of SCANRESULT"),super(),this.thehtml="",this.qrContent="",this.hcert=void 0,this.verified=!1}render(){return a`
            <!-- =========================================== -->
            <!-- SCAN RESULT PAGE.                           -->
            <!-- =========================================== -->
            ${this.thehtml}
        ...
        `);return t}(this.hcert)}catch(i){return void v.myerror("Error rendering credential",i)}this.requestUpdate()}async exit(){}}i(V,"styles",[g,s`
        #footer {
            position: fixed;
            bottom: 0
        }
        `]),customElements.define(B,V);class N extends o{static get properties(){return{pepe:{attribute:!0}}}constructor(){console.log("Inside constructor of SCANRESULT"),super(),this.thehtml="",this.qrContent="",this.hcert=void 0,this.verified=!1}render(){return a`
            <!-- =========================================== -->
            <!-- SCAN RESULT PAGE.                           -->
            <!-- =========================================== -->
            ${this.thehtml}
